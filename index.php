	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agriculture Farm<span>Colombo</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">0751234568</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:Agriculture@gmail.com" style="color:white">Agriculture12@gmail.com</a></p>
			</div>
		</div>
							...
							<form method="post" action="Login/login.php">
								<div class="row uniform 50%">
									...
									<!-- 	<p>
										...
										<div class="1u 3u$(small)">
				                            <input type="radio" id="field officers" name="category" value="0">
				                            <label for="field officers">Field officers</label>
				                        </div> -->
									</div>
									<center>
									<div class="row uniform">
