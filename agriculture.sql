...
CREATE TABLE `admin` (
  ...
  `ahash` varchar(100) NOT NULL,
  `aemail` varchar(100) NOT NULL,
  `amobile` varchar(100) NOT NULL,
  `aaddress` text NOT NULL,
  `aactive` int(100) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `field_officers` (
  `foid` int(100) NOT NULL,
  `foname` varchar(100) NOT NULL,
  `fousername` varchar(100) NOT NULL,
  `fopassword` varchar(100) NOT NULL,
  `fohash` varchar(100) NOT NULL,
  `foemail` varchar(100) NOT NULL,
  `fomobile` varchar(100) NOT NULL,
  `foaddress` text NOT NULL,
  `foactive` int(100) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 'Nazrul_Zameer', 'Zameer', '$2y$10$22ezmzHRa9c5ycHmVm5RpOnlT4LwFaDZar1XhmLRJQKGrcVRhPgti', '61b4a64be663682e8cb037d9719ad8cd', 'zameeer11@gmail.com', '8600611198', 'abcde', 0, 0, 'png', 0);
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `farmer` (`fid`);
